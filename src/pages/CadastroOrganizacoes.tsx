...
const CadastroOrganizacoes = () => {
  ...
  const handleDownloadTemplate = () => {
    window.open(
      "https://docs.google.com/spreadsheets/d/135Cp-IGqRvLnI_5EylayCssfqaxhQM4aN48JlMiLNzg/export?format=xlsx",
      "_blank"
    );
  };
...
export default CadastroOrganizacoes;
